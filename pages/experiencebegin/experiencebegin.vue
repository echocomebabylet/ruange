<template>
	<view>
		<view class="nav">
			...
			<text style="margin-left: 20upx;">体验即将开始</text>
			<text style="font-size: 24upx;">取消预约</text>
		</view>
		<view class="list">
		...
		<view class="info">
			<view>
				...
				<text style="color: #40CCCB">开门暗号：地瓜地瓜，我是土豆！</text>
			</view>
			<view>
				<image src="../../static/u358.png" style="margin-right: 40upx;"></image>					
				<image src="../../static/u359.png"></image>
			</view>
		</view>
	</view>
</template>
