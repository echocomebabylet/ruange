<template>
	<view class="uni-swiper__warp">
        ...
        'width': (index === current? dots.width*2:dots.width*2 ) + 'px','height':dots.width/4 +'px' ,'background-color':index !== current?dots.backgroundColor:dots.selectedBackgroundColor,'border-radius':'0px'}" :key="index" class="uni-swiper__dots-item uni-swiper__dots-bar"/>
		</view>
